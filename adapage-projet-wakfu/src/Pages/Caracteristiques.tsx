  ...
  return (
    ...
    <div className="w-full mx-auto py-6 px-4 relative bg-gray-900 text-center">
      <Header />
        ...
        <div className="w-full md:grid grid-cols-2 gap-4 items-stretch mx-auto">
          {caracteristique.map((Caract) => (
            <>
              {/* carte01 — Physique + Personnalité */}
              <div
                key={`${Caract.id}-physique`}
                className="p-7 bg-linear-to-br from-gray-900 via-red-950 to-gray-900 rounded-2xl text-white border border-yellow-600 shadow flex flex-col h-full mb-3"
              >
